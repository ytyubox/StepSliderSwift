...
extension XCTestCase {
    ...
    func record(snapshot: UIImage, named name: String, file: StaticString = #file, line: UInt = #line) {
        ...
        do {
            ...
            XCTFail("Recorded snapshot at \(snapshotURL), change back to assert before commit", file: file, line: line)
        } catch {
...
//        SnapshotWindow(configuration: configuration, view: self).snapshot()
    }
}
